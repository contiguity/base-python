...
class Contiguity(BaseContiguity):
    class Base(BaseContiguity.Base):
        def _fetch(self, method: str, path: str, body: Optional[Dict] = None) -> Optional[Dict]:
            ...
            try:
                response: Response = self.db._client.request(method, url, headers=headers, json=body)
        ...
        def fetch(self, query: Optional[Dict] = None, limit: Optional[int] = None, last: Optional[str] = None, 
